...
REF_GROUPS = {
    'gymnopedie_1': ['puvis_sacred_grove', 'puvis_summer', 'redon_closed_eyes'],
    'gnossienne_1': ['redon_closed_eyes', 'moreau_galatea', 'puvis_summer'],
    'vexations':    ['whistler_nocturne', 'puvis_sacred_grove', 'redon_closed_eyes'],
}
